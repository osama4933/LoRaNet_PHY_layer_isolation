...
PROGMEM static const RH_RF95::ModemConfig MODEM_CONFIG_TABLE[] =
{
    ...
    //{ 0x72,   0x80,    0x00}, // Bw125Cr45Sf256
    { 0x82,   0x84,    0x00}, // Bw250Cr45Sf256
	////////////////////////////////////
	{ 0x84,   0x84,    0x00}, // Bw250Cr46Sf256
	{ 0x86,   0x84,    0x00}, // Bw250Cr47Sf256
	{ 0x88,   0x84,    0x00}, // Bw250Cr48Sf256
	////////////////////////////////////
    { 0x92,   0x84,    0x00}, // Bw500Cr45Sf256
    { 0x48,   0x94,    0x00}, // Bw31_25Cr48Sf512
    { 0x82,   0x94,    0x00}, // Bw250Cr45Sf512
    { 0x92,   0x94,    0x00}, // Bw500Cr45Sf512
    { 0x82,   0xA4,    0x00}, // Bw250Cr45Sf1024
    { 0x92,   0xA4,    0x00}, // Bw500Cr45Sf1024
    { 0x78,   0xc4,    0x00}, // Bw125Cr48Sf4096
	{ 0x72,   0x84,    0x00}, // Bw125Cr45Sf256
	{ 0x72,   0x94,    0x00}, // Bw125Cr45Sf512
	{ 0x72,   0xa4,    0x00}, // Bw125Cr45Sf1024
	{ 0x72,   0xb4,    0x00}, // Bw125Cr45Sf2048
	{ 0x72,   0xc4,    0x00}, // Bw125Cr45Sf4096
...
//	Serial.println(spiRead(RH_RF95_REG_01_OP_MODE), HEX);
    ...
    // setModemConfig(Bw250Cr48Sf256); // Radio default
	//setModemConfig(Bw250Cr46Sf256); // Radio default
	//setModemConfig(Bw250Cr47Sf256); // Radio default
	//setModemConfig(Bw250Cr48Sf256); // Radio default
...
bool RH_RF95::isChannelActive()
{
 ...
 void RH_RF95::setSpreadingFactor(uint8_t sf)
 {
   ...
   setLowDatarate();
	...
	// Changing SYNC word
 void RH_RF95::setSyncWord(uint8_t sync)
 {
	 spiWrite(RH_RF95_SYNC_WORD, sync);
 }
